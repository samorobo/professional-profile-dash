...
const ExperienceDetail: React.FC<ExperienceDetailProps> = ({ experience, showProgramInfo, onToggleProgramInfo }) => {
  ...
  return (
    <div className="flex flex-col justify-between h-full items-center mt-[2px]">
  <div
    className="bg-gray-900 border border-gray-200 rounded-lg shadow-lg p-6 min-h-[144px] flex flex-col justify-between cursor-pointer w-full mb-8"
  ...
  >
    ...
    <div className="text-center mt-4">
      <ChevronDown
        className={`w-5 h-5 text-gray-400 mx-auto transition-transform ${
          showProgramInfo ? 'rotate-180' : ''
        }`}
      />
    </div>
  </div>
      ...
      {showProgramInfo && (
        <div className="bg-white -mt-4  border-2 border-gray-200 p-6  rounded-lg text-gray-900 shadow-lg w-full">
          ...
          <p className='text-xs text-gray-500 font-normal -md-[-2px]'>Name of the institute</p>
          ...
          <p className='text-xs text-gray-500 font-normal -md-[-2px]'>Position</p>
